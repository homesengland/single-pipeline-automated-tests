...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Sprint 8_US6751-Partner Details API", "\t6751 - Validate the Partner Details APi works as expected", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void Test1PartnerDetailsAPI_AdditionOfNewPartnerDetails(string partner_Name, string account_Type, string account_No, string org_Name, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Test 1 Partner Details API-Addition of new Partner Details", null, @__tags);
#line 5
...
#line hidden
        ...
        public virtual void Test2PartnerDetailsAPI_UpdationOfExistingPartnerDetails(string partner_Name, string account_Type, string account_No, string org_Name, string[] exampleTags)
        {
            ...
            string[] tagsOfScenario = @__tags;
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Test 2 Partner Details API-Updation of existing Partner Details", null, @__tags);
#line 18
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line hidden
        ...
        public virtual void Test3PartnerDetailsAPI_UnauthorisedRequestValidation()
        {
            string[] tagsOfScenario = new string[] {
                    ...
                    "PartnerDetails",
                    "API"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Test 3 Partner Details API-Unauthorised request validation", null, new string[] {
                        "6751",
                        "Sprint8",
                        "PartnerDetails",
                        "API"});
...
#line hidden
        ...
        public virtual void Test4PartnerDetailsAPI_BadRequestValidation()
        {
            string[] tagsOfScenario = new string[] {
                    ...
                    "PartnerDetails",
                    "API"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Test 4 Partner Details API-Bad request validation", null, new string[] {
                        "6751",
                        "Sprint8",
                        "PartnerDetails",
                        "API"});
